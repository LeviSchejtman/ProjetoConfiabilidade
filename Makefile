...
SRC_FILES1=\
  ...
  $(UNITY_ROOT)/src/unity.c \
  $(UNITY_ROOT)/extras/fixture/src/unity_fixture.c \
  $(UNITY_ROOT)/examples/foo/src/sort.c \
  $(UNITY_ROOT)/examples/foo/test/TestFoo.c \
  $(UNITY_ROOT)/examples/foo/test/test_runners/TestFoo_Runner.c \
  $(UNITY_ROOT)/examples/foo/test/test_runners/all_tests.c
